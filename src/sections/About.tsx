    ...
    return <section id="about">
        ...
        <div className="mt-5 flex flex-col text-lg text-center md:text-left gap-5">
            <p>
                ...
                <Badge className="text-base"><strong>Power BI</strong></Badge>, 
                {' '}<Badge className="text-base"><strong>SQL</strong></Badge>, 
                {' '}<Badge className="text-base"><strong>Excel</strong></Badge>, 
                {' '}<Badge className="text-base"><strong>Power Query</strong></Badge>, 
                &
                {' '}<Badge className="text-base"><strong> DAX</strong></Badge> {''}
                to turn raw data
            ...
            <p>
                ...
                that showcase <span className="font-semibold">my ability to analyze,
                visualize, and present data in a clear and impactful way</span>. My goal is to help businesses make smarter
